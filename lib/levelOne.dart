...
import 'package:inverse/levelTwo.dart';
...
class LevelOne extends StatefulWidget {
  ...
  @override
  _LevelOne createState() => _LevelOne();
}

class _LevelOne extends State<LevelOne> with SingleTickerProviderStateMixin {
///////////////////////////////////////////////////////////////
////////////////////Route build begins/////////////////////////
///////////////////////////////////////////////////////////////
  ...
  getData() async {
    ...
    setState(() {
      levelOneFailed = prefs.getBool('levelOneFailed')!;
      validateUnpressed = prefs.getBool('validateUnpressed')!;
    });
  }
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            FloatingActionButton(
                                onPressed: () async {
                                  _validateUserInput(
                                      myController.text, level1C);

                                  SharedPreferences prefs =
                                      await SharedPreferences.getInstance();
                                  prefs.setBool('validateUnpressed', false);
                                },
                          ...
                          children: [
                            ...
                            FloatingActionButton(
                                onPressed: () async {
                                  ...
                                  SharedPreferences prefs =
                                      await SharedPreferences.getInstance();
                                  prefs.setBool('validateUnpressed', true);
                                },
                                tooltip: 'Check your answer',
                                child: const Icon(Icons.check),
                                backgroundColor: Colors.blueGrey.shade900,
                        ...
                        FloatingActionButton(
                          onPressed: () async {
                            SharedPreferences prefs =
                                await SharedPreferences.getInstance();
                            prefs.setBool('validateUnpressed', true);
                            prefs.setBool('levelOneFailed', true);
...
//-set input color to textfiel as red
  ...
  _validateUserInput(String input, String answer) async {
    if (input.toLowerCase().trim().replaceAll(' ', '') == answer) {
      ...
      setState(() {
        prefs.setBool("levelOnePassed", true);
        prefs.setBool('levelOneFailed', false);
        levelOneFailed = prefs.getBool('levelOneFailed')!;
