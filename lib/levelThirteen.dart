...
import 'package:inverse/levelFourteen.dart';
...
class LevelThirteen extends StatefulWidget {
  const LevelThirteen({Key? key}) : super(key: key);

  @override
  _LevelThirteen createState() => _LevelThirteen();
}

class _LevelThirteen extends State<LevelThirteen>
...
///////////////////////////////////////////////////////////////
  ...
  getData() async {
    ...
    setState(() {
      levelThirteenFailed = prefs.getBool('levelThirteenFailed')!;
      validate13Unpressed = prefs.getBool('validate13Unpressed')!;
    });
  }
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            FloatingActionButton(
                                onPressed: () async {
                                  _validateUserInput(
                                      myController.text, level13C);

                                  SharedPreferences prefs =
                                      await SharedPreferences.getInstance();
                                  prefs.setBool('validate13Unpressed', false);
                                },
                          ...
                          children: [
                            ...
                            FloatingActionButton(
                                onPressed: () async {
                                  ...
                                  SharedPreferences prefs =
                                      await SharedPreferences.getInstance();
                                  prefs.setBool('validate13Unpressed', true);
                                },
                                tooltip: 'Check your answer',
                                child: const Icon(Icons.check),
                                backgroundColor: Colors.blueGrey.shade900,
                        ...
                        FloatingActionButton(
                          onPressed: () async {
                            SharedPreferences prefs =
                                await SharedPreferences.getInstance();
                            prefs.setBool('validate13Unpressed', true);
                            prefs.setBool('levelThirteenFailed', true);
...
//-set input color to textfiel as red
  ...
  _validateUserInput(String input, String answer) async {
    if (input.toLowerCase().trim().replaceAll(' ', '') == answer) {
      ...
      setState(() {
        prefs.setBool("levelThirteenPassed", true);
        prefs.setBool('levelThirteenFailed', false);
        levelThirteenFailed = prefs.getBool('levelThirteenFailed')!;
