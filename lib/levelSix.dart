...
import 'package:inverse/levelSeven.dart';
...
class LevelSix extends StatefulWidget {
  const LevelSix({Key? key}) : super(key: key);

  @override
  _LevelSix createState() => _LevelSix();
}

class _LevelSix extends State<LevelSix> with SingleTickerProviderStateMixin {
///////////////////////////////////////////////////////////////
////////////////////Route build begins/////////////////////////
///////////////////////////////////////////////////////////////
  ...
  getData() async {
    ...
    setState(() {
      levelSixFailed = prefs.getBool('levelSixFailed')!;
      validate6Unpressed = prefs.getBool('validate6Unpressed')!;
    });
  }
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            FloatingActionButton(
                                onPressed: () async {
                                  _validateUserInput(
                                      myController.text, level6C);

                                  SharedPreferences prefs =
                                      await SharedPreferences.getInstance();
                                  prefs.setBool('validate6Unpressed', false);
                                },
                          ...
                          children: [
                            ...
                            FloatingActionButton(
                                onPressed: () async {
                                  ...
                                  SharedPreferences prefs =
                                      await SharedPreferences.getInstance();
                                  prefs.setBool('validate6Unpressed', true);
                                },
                                tooltip: 'Check your answer',
                                child: const Icon(Icons.check),
                                backgroundColor: Colors.blueGrey.shade900,
                        ...
                        FloatingActionButton(
                          onPressed: () async {
                            SharedPreferences prefs =
                                await SharedPreferences.getInstance();
                            prefs.setBool('validate6Unpressed', true);
                            prefs.setBool('levelSixFailed', true);

                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => LevelSix(),
                                ));
                          },
...
//-set input color to textfiel as red
  ...
  _validateUserInput(String input, String answer) async {
    if (input.toLowerCase().trim().replaceAll(' ', '') == answer) {
      ...
      setState(() {
        prefs.setBool("levelSixPassed", true);
        prefs.setBool('levelSixFailed', false);
        levelSixFailed = prefs.getBool('levelSixFailed')!;
