...
import 'package:inverse/levelEighteen.dart';
...
class LevelSeventeen extends StatefulWidget {
  const LevelSeventeen({Key? key}) : super(key: key);

  @override
  _LevelSeventeen createState() => _LevelSeventeen();
}

class _LevelSeventeen extends State<LevelSeventeen>
...
///////////////////////////////////////////////////////////////
  ...
  bool levelSeventeenFailed = true;
  bool validate17Unpressed = true;
  ...
  getData() async {
    ...
    setState(() {
      levelSeventeenFailed = prefs.getBool('levelSeventeenFailed')!;
      validate17Unpressed = prefs.getBool('validate17Unpressed')!;
    });
  }
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            FloatingActionButton(
                                onPressed: () async {
                                  _validateUserInput(
                                      myController.text, level17C);

                                  SharedPreferences prefs =
                                      await SharedPreferences.getInstance();
                                  prefs.setBool('validate17Unpressed', false);
                                },
                          ...
                          children: [
                            ...
                            FloatingActionButton(
                                onPressed: () async {
                                  ...
                                  SharedPreferences prefs =
                                      await SharedPreferences.getInstance();
                                  prefs.setBool('validate17Unpressed', true);
                                },
                                tooltip: 'Check your answer',
                                child: const Icon(Icons.check),
                                backgroundColor: Colors.blueGrey.shade900,
                        ...
                        FloatingActionButton(
                          onPressed: () async {
                            SharedPreferences prefs =
                                await SharedPreferences.getInstance();
                            prefs.setBool('validate17Unpressed', true);
                            prefs.setBool('levelSeventeenFailed', true);

                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => LevelSeventeen(),
                                ));
                          },
...
//-set input color to textfiel as red
  ...
  _validateUserInput(String input, String answer) async {
    if (input.toLowerCase().trim().replaceAll(' ', '') == answer) {
      ...
      setState(() {
        prefs.setBool("levelSeventeenPassed", true);
        prefs.setBool('levelSeventeenFailed', false);
        levelSeventeenFailed = prefs.getBool('levelSeventeenFailed')!;
