...
import 'package:inverse/levelSeventeen.dart';
...
class LevelSixteen extends StatefulWidget {
  const LevelSixteen({Key? key}) : super(key: key);

  @override
  _LevelSixteen createState() => _LevelSixteen();
}

class _LevelSixteen extends State<LevelSixteen>
...
///////////////////////////////////////////////////////////////
  ...
  bool levelSixteenFailed = true;
  bool validate16Unpressed = true;
  ...
  getData() async {
    ...
    setState(() {
      levelSixteenFailed = prefs.getBool('levelSixteenFailed')!;
      validate16Unpressed = prefs.getBool('validate16Unpressed')!;
    });
  }
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            FloatingActionButton(
                                onPressed: () async {
                                  _validateUserInput(
                                      myController.text, level16C);

                                  SharedPreferences prefs =
                                      await SharedPreferences.getInstance();
                                  prefs.setBool('validate16Unpressed', false);
                                },
                          ...
                          children: [
                            ...
                            FloatingActionButton(
                                onPressed: () async {
                                  ...
                                  SharedPreferences prefs =
                                      await SharedPreferences.getInstance();
                                  prefs.setBool('validate16Unpressed', true);
                                },
                                tooltip: 'Check your answer',
                                child: const Icon(Icons.check),
                                backgroundColor: Colors.blueGrey.shade900,
                        ...
                        FloatingActionButton(
                          onPressed: () async {
                            SharedPreferences prefs =
                                await SharedPreferences.getInstance();
                            prefs.setBool('validate16Unpressed', true);
                            prefs.setBool('levelSixteenFailed', true);

                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => LevelSixteen(),
                                ));
                          },
...
//-set input color to textfiel as red
  ...
  _validateUserInput(String input, String answer) async {
    if (input.toLowerCase().trim().replaceAll(' ', '') == answer) {
      ...
      setState(() {
        prefs.setBool("levelSixteenPassed", true);
        prefs.setBool('levelSixteenFailed', false);
        levelSixteenFailed = prefs.getBool('levelSixteenFailed')!;
