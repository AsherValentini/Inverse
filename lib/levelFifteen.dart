...
import 'package:inverse/LevelSixteen.dart';
...
class LevelFifteen extends StatefulWidget {
  const LevelFifteen({Key? key}) : super(key: key);

  @override
  _LevelFifteen createState() => _LevelFifteen();
}

class _LevelFifteen extends State<LevelFifteen>
...
///////////////////////////////////////////////////////////////
  ...
  bool levelFifteenFailed = true;
  bool validate15Unpressed = true;
  ...
  getData() async {
    ...
    setState(() {
      levelFifteenFailed = prefs.getBool('levelFifteenFailed')!;
      validate15Unpressed = prefs.getBool('validate15Unpressed')!;
    });
  }
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            FloatingActionButton(
                                onPressed: () async {
                                  _validateUserInput(
                                      myController.text, level15C);

                                  SharedPreferences prefs =
                                      await SharedPreferences.getInstance();
                                  prefs.setBool('validate15Unpressed', false);
                                },
                          ...
                          children: [
                            ...
                            FloatingActionButton(
                                onPressed: () async {
                                  ...
                                  SharedPreferences prefs =
                                      await SharedPreferences.getInstance();
                                  prefs.setBool('validate15Unpressed', true);
                                },
                                tooltip: 'Check your answer',
                                child: const Icon(Icons.check),
                                backgroundColor: Colors.blueGrey.shade900,
                        ...
                        FloatingActionButton(
                          onPressed: () async {
                            SharedPreferences prefs =
                                await SharedPreferences.getInstance();
                            prefs.setBool('validate15Unpressed', true);
                            prefs.setBool('levelFifteenFailed', true);
...
//-set input color to textfiel as red
  ...
  _validateUserInput(String input, String answer) async {
    if (input.toLowerCase().trim().replaceAll(' ', '') == answer) {
      ...
      setState(() {
        prefs.setBool("levelFifteenPassed", true);
        prefs.setBool('levelFifteenFailed', false);
        levelFifteenFailed = prefs.getBool('levelFifteenFailed')!;
