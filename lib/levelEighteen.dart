...
class LevelEighteen extends StatefulWidget {
  const LevelEighteen({Key? key}) : super(key: key);

  @override
  _LevelEighteen createState() => _LevelEighteen();
}

class _LevelEighteen extends State<LevelEighteen>
...
///////////////////////////////////////////////////////////////
  ...
  bool levelEighteenFailed = true;
  bool validate18Unpressed = true;
  ...
  getData() async {
    ...
    setState(() {
      levelEighteenFailed = prefs.getBool('levelEighteenFailed')!;
      validate18Unpressed = prefs.getBool('validate18Unpressed')!;
    });
  }
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            FloatingActionButton(
                                onPressed: () async {
                                  _validateUserInput(
                                      myController.text, level18C);

                                  SharedPreferences prefs =
                                      await SharedPreferences.getInstance();
                                  prefs.setBool('validate18Unpressed', false);
                                },
                          ...
                          children: [
                            ...
                            FloatingActionButton(
                                onPressed: () async {
                                  ...
                                  SharedPreferences prefs =
                                      await SharedPreferences.getInstance();
                                  prefs.setBool('validate18Unpressed', true);
                                },
                                tooltip: 'Check your answer',
                                child: const Icon(Icons.check),
                                backgroundColor: Colors.blueGrey.shade900,
                        ...
                        FloatingActionButton(
                          onPressed: () async {
                            SharedPreferences prefs =
                                await SharedPreferences.getInstance();
                            prefs.setBool('validate18Unpressed', true);
                            prefs.setBool('levelEighteenFailed', true);
...
//-set input color to textfiel as red
  ...
  _validateUserInput(String input, String answer) async {
    if (input.toLowerCase().trim().replaceAll(' ', '') == answer) {
      ...
      setState(() {
        prefs.setBool("levelEighteenPassed", true);
        prefs.setBool('levelEighteenFailed', false);
        levelEighteenFailed = prefs.getBool('levelEighteenFailed')!;
