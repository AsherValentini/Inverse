...
import 'package:inverse/levelFive.dart';
...
class LevelFour extends StatefulWidget {
  ...
  @override
  _LevelFour createState() => _LevelFour();
}

class _LevelFour extends State<LevelFour> with SingleTickerProviderStateMixin {
///////////////////////////////////////////////////////////////
////////////////////Route build begins/////////////////////////
///////////////////////////////////////////////////////////////
  ...
  getData() async {
    ...
    setState(() {
      levelFourFailed = prefs.getBool('levelFourFailed')!;
                        ...
                        FloatingActionButton(
                          onPressed: () async {
                            SharedPreferences prefs =
                                await SharedPreferences.getInstance();
                            prefs.setBool('validate3Unpressed', true);
                            prefs.setBool('levelFourFailed', true);
...
//-set input color to textfiel as red
  ...
  _validateUserInput(String input, String answer) async {
    if (input.toLowerCase().trim().replaceAll(' ', '') == answer) {
      ...
      setState(() {
        prefs.setBool("levelFourPassed", true);
        prefs.setBool('levelFourFailed', false);
        levelFourFailed = prefs.getBool('levelFourFailed')!;
