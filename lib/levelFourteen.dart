...
import 'package:inverse/levelFifteen.dart';
...
class LevelFourteen extends StatefulWidget {
  const LevelFourteen({Key? key}) : super(key: key);

  @override
  _LevelFourteen createState() => _LevelFourteen();
}

class _LevelFourteen extends State<LevelFourteen>
...
///////////////////////////////////////////////////////////////
  ...
  bool levelFourteenFailed = true;
  bool validate14Unpressed = true;
  ...
  getData() async {
    ...
    setState(() {
      levelFourteenFailed = prefs.getBool('levelFourteenFailed')!;
      validate14Unpressed = prefs.getBool('validate14Unpressed')!;
    });
  }
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            FloatingActionButton(
                                onPressed: () async {
                                  _validateUserInput(
                                      myController.text, level14C);

                                  SharedPreferences prefs =
                                      await SharedPreferences.getInstance();
                                  prefs.setBool('validate14Unpressed', false);
                                },
                          ...
                          children: [
                            ...
                            FloatingActionButton(
                                onPressed: () async {
                                  ...
                                  SharedPreferences prefs =
                                      await SharedPreferences.getInstance();
                                  prefs.setBool('validate14Unpressed', true);
                                },
                                tooltip: 'Check your answer',
                                child: const Icon(Icons.check),
                                backgroundColor: Colors.blueGrey.shade900,
                        ...
                        FloatingActionButton(
                          onPressed: () async {
                            SharedPreferences prefs =
                                await SharedPreferences.getInstance();
                            prefs.setBool('validate14Unpressed', true);
                            prefs.setBool('levelFourteenFailed', true);

                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => LevelFourteen(),
                                ));
                          },
...
//-set input color to textfiel as red
  ...
  _validateUserInput(String input, String answer) async {
    if (input.toLowerCase().trim().replaceAll(' ', '') == answer) {
      ...
      setState(() {
        prefs.setBool("levelFourteenPassed", true);
        prefs.setBool('levelFourteenFailed', false);
        levelFourteenFailed = prefs.getBool('levelFourteenFailed')!;
